...
def parse_args(args):
    ...
    parser.add_argument(
        "--filter-ratio", type=float, default=0.8, help="Filtering ratio for CABS-filter."
    )
    ...
    parser.add_argument(
        ...
        default="alt",
        type=str,
        help="Which captions to use. Choices are ['alt', 'recap'].",
    )
    ...
    parser.add_argument(
        ...
        default=30,
        type=int,
        help="What bracket of top concepts to use.",
    )
    ...
    parser.add_argument(
        ...
        default="filter",
        type=str,
        help="Which sampling strategy to use. Choices are ['filter', 'iid'].",
    )
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help="Do CABS on concept frequency.",
    )
    ...
    parser.add_argument(
        "--num-checkpoints", type=int, default=1, help="How often to save checkpoints."
    )
    ...
    parser.add_argument(
        ...
        default=10,
        type=int,
        help="Per-gpu concept cap for CABS-DM.",
    )
    parser.add_argument(
        "--resume",
        default=None,
    ...
    parser.add_argument(
        ...
        type=str,
        default='bethge-lab',
        help="Name of the team if logging with wandb.",
    )
    parser.add_argument(
        "--wandb-project-name",
        type=str,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Enable training-time diagnostic logging (gradient stats, embedding geometry, etc.).",
    )
    parser.add_argument(
        "--diag-every-n-steps",
        type=int,
        default=100,
        help="Compute diagnostic metrics every N training steps.",
    )
    parser.add_argument(
        "--diag-save-snapshots",
        default=False,
        action="store_true",
        help="Save embedding snapshots to disk at diagnostic intervals (for post-hoc analysis).",
    )
